...
const Tiptap = (props: any) => {
  ...
  if (props.mode === "editor") {
    return <EditorStyle >
      ...
      <EditorContent editor={editor} style={{ height: props.height, overflow: 'auto', padding: '0 0.5rem' }} ref={props.editorRef} className="content" />
    </EditorStyle>
  } else {
    return <ReaderStyle >
      <EditorContent editor={editor} style={{ minHeight: props.height }} className="content" />
    </ReaderStyle>
  }
};
