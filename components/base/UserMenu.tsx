const UserMenu = ({ onGetIssueList, onSetIssue, onSignin, toggleTab, user }: any) => {
    return <>
        <div className="flex items-center">
            <button className="mr-5 hover:text-cusblue-dark" onClick={onGetIssueList}>
            ...
            {user.email ?
                <>
                    <button className="mr-5 bg-cusblue-base hover:bg-cusblue-dark rounded-full px-3 py-2 text-white" onClick={onSetIssue}>이슈 등록</button>
