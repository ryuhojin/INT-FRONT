...
const IssueWrite = ({ title, setTitle, content, setContent, tag, setChagneTag, setDeleteTag, addIssue }: any) => {
    return <>
        <div className="w-full flex flex-col items-center mt-4">
            <div className=" md:w-1/2 w-full">
                ...
                <button className="mb-8 bg-cusblue-base border hover:bg-cusblue-light px-2 py-1 text-white rounded-md mt-4 w-full" onClick={addIssue}>글쓰기</button>
            </div>
        </div>
    </>
}
